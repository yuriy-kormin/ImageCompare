...
{
    /// <summary>A utility class to validate input data related to image comparisons.</summary>
    public class InputDataValidator
    {
        /// <summary>Checks if two bitmaps have the same dimensions (width and height).</summary>
        ///
