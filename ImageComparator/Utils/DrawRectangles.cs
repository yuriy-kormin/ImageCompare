...
{
    /// <summary>
    /// A utility class to draw rectangles on a bitmap for visual comparison.
    /// </summary>
    public class DrawRectangles
    {   
        /// <summary>
        /// Pen used for drawing debug rectangles (with debug color).
        /// </summary>
        private static Pen DebugPen { get; } = new Pen(Settings.DebugRectColor, 1);

        /// <summary>
        /// Pen used for drawing main rectangles (with the main color).
        /// </summary>
        private static Pen MainPen { get; } = new Pen(Settings.RectColor, 1);

        /// <summary>
        /// Draws a rectangle border on a bitmap at the specified location.
        /// </summary>
        ...
        {
            // If in debug mode, adjust the rectangle size
            if (debug)
            {
