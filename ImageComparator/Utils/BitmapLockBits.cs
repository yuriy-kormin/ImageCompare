...
namespace ImageComparator.Utils
{
    ...
    public class BitmapLockBits
    {
        ...
        {
            // Create a rectangle representing the entire Bitmap to lock its bits
            Rectangle rect = new Rectangle(0, 0, bitmap.Width, bitmap.Height);

            // Lock the bits of the Bitmap with the specified mode and return the BitmapData object
