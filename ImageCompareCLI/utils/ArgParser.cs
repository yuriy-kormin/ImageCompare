...
{
    /// <summary>
    /// Provides functionality to parse and validate command-line arguments for the Image Compare CLI utility.
    /// </summary>
    public static class ArgParser
    {
        /// <summary> /// Gets the default name for the output image file.</summary>
        /// <value>The default filename is "output.jpg".</value>
        public static string OutputFilename { get; } = "output.jpg";

        /// <summary>A dictionary containing default argument values and their corresponding keys.</summary>
        /// <remarks>
        ...
        /// <summary>
        /// Parses the command-line arguments and updates the <see cref="Args"/> dictionary with provided values.
        /// </summary>
        /// 
