...
{
    /// <summary>
    /// Updates the settings for the image comparison process based on the provided command-line arguments.
    /// </summary>
    public class SettingsUpdater
    {
        /// <summary>
        /// Updates the <see cref="Settings"/> configuration using the values parsed from the command-line arguments.
        /// </summary>
        ///
        /// <remarks>
